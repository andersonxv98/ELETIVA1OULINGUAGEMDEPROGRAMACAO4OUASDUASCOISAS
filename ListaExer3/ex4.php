...
<form method="post" action="exer4.php">
    <div class="row">
        <div class="col">
            <label for="valor1" class="label-control">Insira Numero</label>
            <input type="number" name="valor1" id="valor1" class="form-control">
        </div>
        <div class="col">
            <label for="valor2" class="label-control">Insira o Numnero</label>
            <input type="number" name="valor2" id="valor2" class="form-control">
        </div>
        <div class="col">
            <label for="valor3" class="label-control">Insira o Numnero</label>
            <input type="number" name="valor3" id="valor3" class="form-control">
        </div>
        <div class="col">
            <label for="valor4" class="label-control">Insira o Numnero</label>
            <input type="number" name="valor4" id="valor4" class="form-control">
        </div>
        <div class="col">
            <label for="valor5" class="label-control">Insira o Numnero</label>
