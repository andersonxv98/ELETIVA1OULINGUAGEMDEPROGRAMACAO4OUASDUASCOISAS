                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form action="resposta.php" method="POST">
                            ...
                            for ($l=0; $l <$_SESSION['n_voltas'] ; $l++) { 
                            echo "<div class='row'>";
                            echo       "<div class='col'>";
                            echo          "<label for='valor$l' class='label-control'>";
                            echo             "Informe o Tempo da Volta";
                            echo         "</label>";
                            echo       "<input type='time' name='valor$l' id='valor$l'class='form-control'/>";
                            echo   "</div>";
                            echo  "</div>"; 
                            }
                            ?>
