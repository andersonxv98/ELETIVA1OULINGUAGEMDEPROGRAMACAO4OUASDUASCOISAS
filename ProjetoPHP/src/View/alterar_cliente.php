        ...
        <div class="row">
            <div class="col-5">
                ...
                <input type="text" class="form-control"
                        name="nome" id="nome" value="<?php $resultado['nome'] ?>"/>
            </div>
            <div class="col-5">
                ...
                <input type="text" class="form-control"
                        name="email" id="email" value="<?php $resultado['email'] ?>/>
            </div>
            <div class="col-2">
                ...
                <input type="number" class="form-control"
                        name="idade" id="idade" value="<?php $resultado['idade'] ?>/>
            </div>
        </div>
        <div class="row">
            <div class="col mt-5">
